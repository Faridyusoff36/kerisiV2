 ...
 * wired as read-only detail on GET payee-registration/{id} / Kerisi /m/1713.
 */
class PayeeRegistrationController extends Controller
{
    ...
    /**
     * Read-only payee detail for hidden menu MENUID 1713 (Payee Registration Details).
     */
    public function show(string $id): JsonResponse
    {
        ...
        if ($row === null) {
            return $this->sendError(404, 'NOT_FOUND', 'Payee not found');
        }
