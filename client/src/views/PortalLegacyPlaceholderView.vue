...
/** Portal legacy screens not yet ported (financial info, work order, overtime, advance staff, TP1, stock, etc.). */
...
const crumb = computed(() => props.breadcrumb ?? `Portal / ${props.title}`);
      ...
      <article class="rounded-lg border border-slate-200 bg-white shadow-sm">
        <div class="flex flex-col items-center justify-center px-4 py-14 text-center">
          ...
          <p class="mt-2 max-w-lg text-sm text-slate-600">
            {{
              description ??
              "This legacy Portal screen is not reproduced in Kerisi20. Use Kerisi Classic for the full workflow."
            }}
          </p>
          <button
