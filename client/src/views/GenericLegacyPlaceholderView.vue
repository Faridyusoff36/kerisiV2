...
/**
 * Generic legacy-page placeholder used for any module that does not have a
 * dedicated `*LegacyPlaceholderView.vue` (e.g. Account Payable / Receivable
 * extras, Budget, Purchasing, Petty Cash, Debtor Portal, Vendor Portal, EIS,
 * GL Financial Statement helpers).
 */
...
const crumb = computed(() => props.breadcrumb ?? props.title);
      ...
      <article class="rounded-lg border border-slate-200 bg-white shadow-sm">
        <div class="flex flex-col items-center justify-center px-4 py-14 text-center">
          ...
          <p class="mt-2 max-w-lg text-sm text-slate-600">
            {{
              description ??
              "This legacy screen is not reproduced in Kerisi20. Use Kerisi Classic for the full workflow."
            }}
          </p>
          <button
