              ...
              <table class="admin-table-kitchen w-full min-w-[900px] text-sm">
                ...
                <tbody>
                  <tr v-for="row in rows" :key="row.bpmId" class="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td class="px-3 py-2">
                      <div class="flex items-center gap-1">
                        <button type="button" class="rounded p-1 text-slate-500 hover:bg-slate-100" title="Duplicate" @click="duplicateRow(row)">
                  ...
                  <tr v-if="rows.length === 0">
                    <td colspan="9" class="admin-table-kitchen-caption">No records</td>
                  </tr>
                </tbody>
              </table>
            </div>
