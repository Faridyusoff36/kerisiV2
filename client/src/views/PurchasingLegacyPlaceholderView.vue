...
/** Hidden purchasing pages whose legacy BL/wizard is not ported; navigation shell + related links. */
...
const crumb = computed(() => props.breadcrumb ?? `Purchasing / ${props.title}`);
      ...
      <article class="rounded-lg border border-slate-200 bg-white shadow-sm">
        <div class="flex flex-col items-center justify-center px-4 py-14 text-center">
          ...
          <p class="mt-2 max-w-lg text-sm text-slate-600">
            {{
              description ??
              "This legacy purchasing screen is not reproduced in Kerisi20. Use Kerisi Classic for the full workflow."
            }}
          </p>
          <button
