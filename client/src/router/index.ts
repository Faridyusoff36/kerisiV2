...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/admin/kerisi/m/3039", name: "kerisi-rem-3039", component: KerisiRemainingPageView, meta: { requiresAuth: true, title: "Purchase Requisition Cancel" } },
    ...
    { path: "/admin/kerisi/m/3042", name: "kerisi-rem-3042", component: KerisiRemainingPageView, meta: { requiresAuth: true, title: "Purchase Requisition Cancel Partial" } },
